...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5">
        <h1 class="display-4 text-white animated slideInDown mb-4">Manutenção de Chiller</h1>
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    <h1 class="display-6 mb-5"style="color:#FF800F">Manutenção de Chiller</h1>
                    ...
                    <p class="mb-4"> A instalação de um sistema de ar condicionado pode ser uma tarefa complexa e
                        delicada, que
                    ...
                    <p class="mb-4">Como uma empresa líder em manutenção e instalação de ar condicionado na região de
                        Curitiba,
                    ...
                    <p class="mb-4">A instalação adequada de um sistema de ar condicionado pode proporcionar uma
                        melhoria
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-6 text-end">
                        <img class="" data-wow-delay="0.1s" src="{{ asset('/dist/img/chiller1.jpg') }}"
                            style="width:600px;">
                    </div>
                </div>
            </div>
